...
def data():
    ...
    return x_train, bs_x_train, y_train, x_test, bs_x_test, y_test
...
def model(x_train,bs_x_train,y_train,x_test,bs_x_test,y_test):
    """
...
if __name__ == '__main__':
    best_run, best_model = optim.minimize(model=model,
                                          ...
                                          trials=Trials(),
                                          keep_temp=True)
    x_train, bs_x_train, y_train, x_test, bs_x_test, y_test = data()

    with open("optimisation_singles.txt","w") as f:
        print("Evaluation of best performing model:",file=f)
        print(best_model.evaluate([x_test,bs_x_test], y_test),file=f)
