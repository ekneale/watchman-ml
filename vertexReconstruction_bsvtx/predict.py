...
Y_tmp = y_tmp[:,:3] # we only want mcx, mcy and mcz (first three columns) for now
Y = Y_tmp
...
'''
f_old = ROOT.TFile("fred_ibd_flat_predict.root","read")
tree_old = f_old.Get("data")
f_new = ROOT.TFile("results_singles_bsvtx.root","recreate")
