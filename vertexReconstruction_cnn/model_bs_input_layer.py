...
#    flat2 = Flatten()(bonsai_vtx)
    ...
    # merge input models
    merge = Concatenate()([flat1,bonsai_vtx])

    # interpretation model
    hidden1 = Dense(neurons1, kernel_initializer=initialiser1, activation=activation1)(merge)
...
#    model.add(Dropout(dropout3))
    output = Dense(num_outputs, kernel_initializer=initialiser4, activation=activation4)(hidden3)
