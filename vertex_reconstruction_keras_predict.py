...
model.add(Dense(num_outputs, kernel_initializer='he_uniform', activation='linear')) 
# Print model summary
model.summary()
...
# Make the prediction
y_predicted_scaled = model.predict(x_predict,batch_size=12)
...
'''
f_old = ROOT.TFile("mcdata_pair_no_noise_predict.root","read")
tree_old = f_old.Get("data")
f_new = ROOT.TFile("mcdata_pair_no_noise_predict_update.root","recreate")
